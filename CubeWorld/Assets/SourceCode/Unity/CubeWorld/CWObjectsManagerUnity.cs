...
namespace GameScene
{
    public class CWObjectsManagerUnity : ICWListener
    {
        ...
        public CWObjectsManagerUnity(GameScene gameScene, GameManagerUnity gameManagerUnity)
        {
        ...
        public GameObject CreateAvatarGameObject(CubeWorld.Avatars.Avatar avatar)
        {
            ...
            if (avatar.definition.id == "player")
            {
                ...
                gameManagerUnity.playerUnity.gameScene = gameScene;
                gameManagerUnity.playerUnity.avatar = avatar;
                gameManagerUnity.playerUnity.Reset();
                var playerGUI = g.GetComponent<PlayerGUI>();
                playerGUI.gameScene = gameScene;
            }
            else
            {
                g = new GameObject();
